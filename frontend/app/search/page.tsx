...
export const metadata: Metadata = {
  ...
  description:
    'ابحث في آلاف الأحكام القضائية السعودية من محاكم الدرجة الأولى ومحكمة الاستئناف. فلترة حسب نوع المحكمة والمدينة والسنة. محرك بحث قانوني متخصص في الأحكام السعودية ونظام ناجز.',
  keywords: [
    'بحث الأحكام',
    'أحكام قضائية سعودية',
    'محكمة',
      ...
      <noscript>
        <div className="max-w-3xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-lg text-slate-600 mb-8">
            ...
            فلترة حسب نوع المحكمة والمدينة والسنة. محرك بحث قانوني متخصص في الأحكام السعودية ونظام ناجز.
          </p>
