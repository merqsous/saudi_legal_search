...
export const metadata: Metadata = {
  ...
  keywords: ['خصوصية الباحث', 'سياسة الخصوصية', 'حماية البيانات', 'الأحكام القضائية'],
  alternates: {
  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-ink-900 mb-8">سياسة الخصوصية</h1>

        <div className="bg-white rounded-2xl border border-ink-100 p-6 md:p-8 space-y-6">
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">1. البيانات التي نجمعها</h2>
            <p className="text-ink-700 leading-relaxed text-sm mb-2">نجمع البيانات التالية لتقديم وتحسين خدماتنا:</p>
            <ul className="space-y-2 text-sm text-ink-700 mr-4">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">2. كيف نستخدم بياناتك</h2>
            <ul className="space-y-2 text-sm text-ink-700 mr-4">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">3. حماية البيانات</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">4. ملفات تعريف الارتباط (Cookies)</h2>
            <p className="text-ink-700 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">5. خدمات الطرف الثالث</h2>
            <p className="text-ink-700 leading-relaxed text-sm">
              نستخدم خدمات خارجية لتشغيل المنصة، بما في ذلك:
            </p>
            <ul className="space-y-2 text-sm text-ink-700 mr-4 mt-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">6. حقوق المستخدم</h2>
            <p className="text-ink-700 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">7. الأطفال</h2>
            <p className="text-ink-700 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">8. التحديثات</h2>
            <p className="text-ink-700 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">9. التواصل</h2>
            <p className="text-ink-700 leading-relaxed text-sm">
