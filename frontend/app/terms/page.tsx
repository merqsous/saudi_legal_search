...
export const metadata: Metadata = {
  ...
  keywords: ['شروط الباحث', 'أحكام الاستخدام', 'الخصوصية', 'الاشتراك'],
  alternates: {
  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-ink-900 mb-8">الشروط والأحكام</h1>

        <div className="bg-white rounded-2xl border border-ink-100 p-6 md:p-8 space-y-6">
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">1. قبول الشروط</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">2. وصف الخدمة</h2>
            <p className="text-ink-700 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">3. الاشتراك والأسعار</h2>
            <p className="text-ink-700 leading-relaxed text-sm mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">4. استخدام الخدمة</h2>
            <p className="text-ink-700 leading-relaxed text-sm mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">5. مصدر الأحكام</h2>
            <p className="text-ink-700 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">6. الدراسة القانونية التحليلية</h2>
            <p className="text-ink-700 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">7. إخلاء المسؤولية</h2>
            <p className="text-ink-700 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink-900 mb-3">8. التعديلات</h2>
            <p className="text-ink-700 leading-relaxed text-sm">
