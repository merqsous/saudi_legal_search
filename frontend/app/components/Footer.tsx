...
export default function Footer() {
  return (
    <footer className="bg-ink-950 text-ink-300" dir="rtl">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><a href="/support" className="text-sm text-ink-400 hover:text-white transition-colors">الدعم الفني</a></li>
              <li><a href="/terms" className="text-sm text-ink-400 hover:text-white transition-colors">الشروط والأحكام</a></li>
              <li><a href="/privacy" className="text-sm text-ink-400 hover:text-white transition-colors">سياسة الخصوصية</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <a href="mailto:albahethapp@gmail.com" className="text-sm text-ink-400 hover:text-white transition-colors flex items-center gap-2">
                  <Mail className="w-4 h-4 shrink-0" />
                  albahethapp@gmail.com
                </a>
              </li>
              <li>
                <a href="https://wa.me/966533226864" target="_blank" rel="noopener noreferrer" className="text-sm text-ink-400 hover:text-white transition-colors flex items-center gap-2">
                  <Phone className="w-4 h-4 shrink-0" />
                  واتساب: 966533226864
                </a>
              </li>
              <li>
                <a href="https://x.com/albahethapp" target="_blank" rel="noopener noreferrer" className="text-sm text-ink-400 hover:text-white transition-colors flex items-center gap-2">
